...
title MSST - Installer

echo =======================================================
echo     Music Source Separation Training - Installer
echo =======================================================
echo.
...
echo [PROCESS] Cloning Music-Source-Separation-Training repository...
...
REM Relocate the GUI script to the project root
echo [PROCESS] Moving GUI interface to the root directory...
if exist "%REPO_DIR%\gui\gui-wx.py" (
    move "%REPO_DIR%\gui\gui-wx.py" "%REPO_DIR%\gui-wx.py" >nul
    echo [SUCCESS] Repository setup complete.
) else (
    echo [WARNING] gui-wx.py not found in the 'gui' folder.
)
echo.
